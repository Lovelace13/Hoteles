        ...
        children: [
            {
                path: 'discover', children: [{
                    ...
                    {
                        path: ':placeId',
                        loadChildren: () => __webpack_require__.e(/*! import() | discover-place-detail-place-detail-module */ "common").then(__webpack_require__.bind(null, /*! ./discover/place-detail/place-detail.module */ "./src/app/places/discover/place-detail/place-detail.module.ts")).then(m => m.PlaceDetailPageModule)
                    }]
            },
            {
                path: 'offers', children: [
                    ...
                    {
                        path: 'new',
                        loadChildren: () => __webpack_require__.e(/*! import() | offers-new-offer-new-offer-module */ "new-offer-new-offer-module").then(__webpack_require__.bind(null, /*! ./offers/new-offer/new-offer.module */ "./src/app/places/offers/new-offer/new-offer.module.ts")).then(m => m.NewOfferPageModule)
                    },
                    {
                        path: 'edit/:placeId',
                        loadChildren: () => __webpack_require__.e(/*! import() | offers-edit-offer-edit-offer-module */ "common").then(__webpack_require__.bind(null, /*! ./offers/edit-offer/edit-offer.module */ "./src/app/places/offers/edit-offer/edit-offer.module.ts")).then(m => m.EditOfferPageModule)
                    },
                    {
                        path: ':placeId',
                        loadChildren: () => __webpack_require__.e(/*! import() | offers-offer-bookings-offer-bookings-module */ "common").then(__webpack_require__.bind(null, /*! ./offers/offer-bookings/offer-bookings.module */ "./src/app/places/offers/offer-bookings/offer-bookings.module.ts")).then(m => m.OfferBookingsPageModule)
                    }
                ]
            },
            {
