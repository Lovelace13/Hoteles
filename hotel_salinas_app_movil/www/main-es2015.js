...
const routes = [
    { path: '', redirectTo: 'places', pathMatch: 'full' },
    {
        ...
        children: [
            ...
            {
                path: 'signup',
                loadChildren: () => __webpack_require__.e(/*! import() | auth-sign-up-sign-up-module */ "sign-up-sign-up-module").then(__webpack_require__.bind(null, /*! ./auth/sign-up/sign-up.module */ "./src/app/auth/sign-up/sign-up.module.ts")).then(m => m.SignUpPageModule)
            },
            {
                path: 'signin',
                loadChildren: () => __webpack_require__.e(/*! import() | auth-sign-in-sign-in-module */ "sign-in-sign-in-module").then(__webpack_require__.bind(null, /*! ./auth/sign-in/sign-in.module */ "./src/app/auth/sign-in/sign-in.module.ts")).then(m => m.SignInPageModule)
            }
        ]
    },
    {
...
let AuthService = class AuthService {
    constructor(http) {
        this.http = http;
        this.registerEmailUpdated = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subject"]();
        this._userIsAuthenticated = false;
        this.server_url = 'https://hotelsalinasec.cloudns.cl/';
    }
    ...
    loginValidation(email) {
        var prefix = 'auth/search/cliente';
        var enPoint = this.server_url + prefix;
        var params = {
            "email": email
        };
...
module.exports = __webpack_require__(/*! C:\Users\david\Desktop\Coding\IngSoftwareESPOL\hotel_salinas_app_movil\src\main.ts */"./src/main.ts");
