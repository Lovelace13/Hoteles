...
const routes = [
    ...
    {
        path: 'sign-up',
        loadChildren: () => __webpack_require__.e(/*! import() | sign-up-sign-up-module */ "sign-up-sign-up-module").then(__webpack_require__.bind(null, /*! ./sign-up/sign-up.module */ "./src/app/auth/sign-up/sign-up.module.ts")).then(m => m.SignUpPageModule)
    },
    {
        path: 'sign-in',
        loadChildren: () => __webpack_require__.e(/*! import() | sign-in-sign-in-module */ "sign-in-sign-in-module").then(__webpack_require__.bind(null, /*! ./sign-in/sign-in.module */ "./src/app/auth/sign-in/sign-in.module.ts")).then(m => m.SignInPageModule)
    }
];
