...
const routes = [
    ...
    { path: 'edit-profile', loadChildren: () => __webpack_require__.e(/*! import() | pages-edit-profile-edit-profile-module */ "pages-edit-profile-edit-profile-module").then(__webpack_require__.bind(null, /*! ./pages/edit-profile/edit-profile.module */ "./src/app/pages/edit-profile/edit-profile.module.ts")).then(m => m.EditProfilePageModule) },
    ...
    { path: 'hotel-list', loadChildren: () => __webpack_require__.e(/*! import() | pages-hotel-list-hotel-list-module */ "pages-hotel-list-hotel-list-module").then(__webpack_require__.bind(null, /*! ./pages/hotel-list/hotel-list.module */ "./src/app/pages/hotel-list/hotel-list.module.ts")).then(m => m.HotelListPageModule) },
    { path: 'hotel-detail/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-hotel-detail-hotel-detail-module */ "pages-hotel-detail-hotel-detail-module").then(__webpack_require__.bind(null, /*! ./pages/hotel-detail/hotel-detail.module */ "./src/app/pages/hotel-detail/hotel-detail.module.ts")).then(m => m.HotelDetailPageModule) },
    { path: 'hotel-checkout/:hotelID/:roomID', loadChildren: () => __webpack_require__.e(/*! import() | pages-hotel-checkout-hotel-checkout-module */ "pages-hotel-checkout-hotel-checkout-module").then(__webpack_require__.bind(null, /*! ./pages/hotel-checkout/hotel-checkout.module */ "./src/app/pages/hotel-checkout/hotel-checkout.module.ts")).then(m => m.HotelCheckoutPageModule) },
    { path: 'booking-list', loadChildren: () => __webpack_require__.e(/*! import() | pages-booking-list-booking-list-module */ "pages-booking-list-booking-list-module").then(__webpack_require__.bind(null, /*! ./pages/booking-list/booking-list.module */ "./src/app/pages/booking-list/booking-list.module.ts")).then(m => m.BookingListPageModule) },
    { path: 'favorites', loadChildren: () => __webpack_require__.e(/*! import() | pages-favorites-favorites-module */ "pages-favorites-favorites-module").then(__webpack_require__.bind(null, /*! ./pages/favorites/favorites.module */ "./src/app/pages/favorites/favorites.module.ts")).then(m => m.FavoritesPageModule) },
    { path: 'local-weather', loadChildren: () => __webpack_require__.e(/*! import() | pages-local-weather-local-weather-module */ "pages-local-weather-local-weather-module").then(__webpack_require__.bind(null, /*! ./pages/local-weather/local-weather.module */ "./src/app/pages/local-weather/local-weather.module.ts")).then(m => m.LocalWeatherPageModule) },
    { path: 'about', loadChildren: () => __webpack_require__.e(/*! import() | pages-about-about-module */ "pages-about-about-module").then(__webpack_require__.bind(null, /*! ./pages/about/about.module */ "./src/app/pages/about/about.module.ts")).then(m => m.AboutPageModule) },
    { path: 'support', loadChildren: () => __webpack_require__.e(/*! import() | pages-support-support-module */ "pages-support-support-module").then(__webpack_require__.bind(null, /*! ./pages/support/support.module */ "./src/app/pages/support/support.module.ts")).then(m => m.SupportPageModule) },
    { path: 'messages', loadChildren: () => Promise.all(/*! import() | pages-messages-messages-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-messages-messages-module")]).then(__webpack_require__.bind(null, /*! ./pages/messages/messages.module */ "./src/app/pages/messages/messages.module.ts")).then(m => m.MessagesPageModule) },
    { path: 'message/:id', loadChildren: () => Promise.all(/*! import() | pages-message-message-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-message-message-module")]).then(__webpack_require__.bind(null, /*! ./pages/message/message.module */ "./src/app/pages/message/message.module.ts")).then(m => m.MessagePageModule) },
    { path: 'rentcar', loadChildren: () => __webpack_require__.e(/*! import() | pages-rentcar-rentcar-module */ "pages-rentcar-rentcar-module").then(__webpack_require__.bind(null, /*! ./pages/rentcar/rentcar.module */ "./src/app/pages/rentcar/rentcar.module.ts")).then(m => m.RentcarPageModule) },
    { path: 'cars-list', loadChildren: () => __webpack_require__.e(/*! import() | pages-cars-list-cars-list-module */ "pages-cars-list-cars-list-module").then(__webpack_require__.bind(null, /*! ./pages/cars-list/cars-list.module */ "./src/app/pages/cars-list/cars-list.module.ts")).then(m => m.CarsListPageModule) },
    { path: 'car-detail/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-car-detail-car-detail-module */ "pages-car-detail-car-detail-module").then(__webpack_require__.bind(null, /*! ./pages/car-detail/car-detail.module */ "./src/app/pages/car-detail/car-detail.module.ts")).then(m => m.CarDetailPageModule) },
    { path: 'car-checkout/:carshopID/:carID', loadChildren: () => __webpack_require__.e(/*! import() | pages-car-checkout-car-checkout-module */ "pages-car-checkout-car-checkout-module").then(__webpack_require__.bind(null, /*! ./pages/car-checkout/car-checkout.module */ "./src/app/pages/car-checkout/car-checkout.module.ts")).then(m => m.CarCheckoutPageModule) },
    { path: 'location', loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./pages/modal/location/location.module */ "./src/app/pages/modal/location/location.module.ts")).then(m => m.LocationPageModule) },
    { path: 'activities', loadChildren: () => __webpack_require__.e(/*! import() | pages-activities-activities-module */ "pages-activities-activities-module").then(__webpack_require__.bind(null, /*! ./pages/activities/activities.module */ "./src/app/pages/activities/activities.module.ts")).then(m => m.ActivitiesPageModule) },
    { path: 'activity-list', loadChildren: () => __webpack_require__.e(/*! import() | pages-activity-list-activity-list-module */ "pages-activity-list-activity-list-module").then(__webpack_require__.bind(null, /*! ./pages/activity-list/activity-list.module */ "./src/app/pages/activity-list/activity-list.module.ts")).then(m => m.ActivityListPageModule) },
    { path: 'activity-detail/:id', loadChildren: () => __webpack_require__.e(/*! import() | pages-activity-detail-activity-detail-module */ "pages-activity-detail-activity-detail-module").then(__webpack_require__.bind(null, /*! ./pages/activity-detail/activity-detail.module */ "./src/app/pages/activity-detail/activity-detail.module.ts")).then(m => m.ActivityDetailPageModule) },
    { path: 'activity-checkout/:tripID', loadChildren: () => __webpack_require__.e(/*! import() | pages-activity-checkout-activity-checkout-module */ "pages-activity-checkout-activity-checkout-module").then(__webpack_require__.bind(null, /*! ./pages/activity-checkout/activity-checkout.module */ "./src/app/pages/activity-checkout/activity-checkout.module.ts")).then(m => m.ActivityCheckoutPageModule) },
...
/* harmony import */ var _providers_translate_translate_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./providers/translate/translate.service */ "./src/app/providers/translate/translate.service.ts");
...
let AppComponent = class AppComponent {
     ...
     */
    constructor(platform, translate, translateService, navCtrl) {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            this.translateService.setDefaultLang(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].language);
            this.translateService.use(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].language);
            this.translateService.getTranslation(_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].language).subscribe(translations => {
...
/* harmony import */ var _providers__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./providers */ "./src/app/providers/index.ts");
/* harmony import */ var _pages_modal_image_image_module__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./pages/modal/image/image.module */ "./src/app/pages/modal/image/image.module.ts");
/* harmony import */ var _pages_modal_location_location_module__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./pages/modal/location/location.module */ "./src/app/pages/modal/location/location.module.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonicModule"].forRoot(_environments_environment__WEBPACK_IMPORTED_MODULE_12__["environment"].config),
            _app_routing_module__WEBPACK_IMPORTED_MODULE_14__["AppRoutingModule"],
            _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
            _pages_modal_image_image_module__WEBPACK_IMPORTED_MODULE_16__["ImagePageModule"],
            _pages_modal_location_location_module__WEBPACK_IMPORTED_MODULE_17__["LocationPageModule"],
        ...
        providers: [
            ...
            _providers__WEBPACK_IMPORTED_MODULE_15__["TranslateProvider"],
            _providers__WEBPACK_IMPORTED_MODULE_15__["HotelProvider"]
        ],
...
let ImagePage = class ImagePage {
    constructor(nav, modalCtrl, sanitizer) {
        this.nav = nav;
...
ImagePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-image',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./image.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/modal/image/image.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./image.page.scss */ "./src/app/pages/modal/image/image.page.scss")).default]
    })
], ImagePage);
...
LocationPage.propDecorators = {
    fromto: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
...
LocationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./location.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/modal/location/location.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./location.page.scss */ "./src/app/pages/modal/location/location.page.scss")).default]
    })
], LocationPage);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _mock_activities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock-activities */ "./src/app/providers/activities/mock-activities.ts");
...
let activities = [
    {
        ...
        images: [
            "assets/img/trip/thumb/trip1/trip_1.jpg",
            "assets/img/trip/thumb/trip1/trip_2.jpg",
            "assets/img/trip/thumb/trip1/trip_3.jpg",
            "assets/img/trip/thumb/trip1/trip_4.jpg",
        ],
        highlights: [
            "Actividades acuáticas (incluida)",
    ...
    },
    {
        ...
        location: "Galapagos Islands, Petrel, Puerto Ayora",
        images: [
            "assets/img/trip/thumb/trip2/trip_1.jpg",
            "assets/img/trip/thumb/trip2/trip_2.jpg",
            "assets/img/trip/thumb/trip2/trip_3.jpg",
            "assets/img/trip/thumb/trip2/trip_4.jpg",
        ],
        highlights: [
            "Guía profesional",
            "Almuerzo",
            "Uso de equipo de snorkel (mascarilla y aletas)",
            "Recogida en el hotel (dentro del perímetro urbano de Puerto Ayora )",
            "Transporte",
        ]
    },
    {
        ...
        location: "Galapagos Islands, Petrel, Puerto Ayora",
        images: [
            "assets/img/trip/thumb/trip3/trip_1.jpg",
            "assets/img/trip/thumb/trip3/trip_2.jpg",
            "assets/img/trip/thumb/trip3/trip_3.jpg",
            "assets/img/trip/thumb/trip3/trip_4.jpg",
        ],
        highlights: [
            "Guía profesional",
            "Almuerzo",
    ...
    },
    {
        ...
        images: [
            "assets/img/trip/thumb/trip4/trip_1.jpg",
            "assets/img/trip/thumb/trip4/trip_2.jpg",
            "assets/img/trip/thumb/trip4/trip_3.jpg",
            "assets/img/trip/thumb/trip4/trip_4.jpg",
        ],
        highlights: [
            "Transporte desde el Hotel ",
            "Guía Certificado del Parque Nacional Galápagos en Inglés o Español",
            "Uso de equipo de snorkel (mascarilla y aletas)",
            "Recogida en el hotel (dentro del perímetro urbano de Puerto Ayora)",
            "Transporte",
        ]
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _mock_cars__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock-cars */ "./src/app/providers/cars/mock-cars.ts");
...
CarsService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], CarsService);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HotelProvider", function() { return HotelProvider; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _mock_hotels__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock-hotels */ "./src/app/providers/hotel/mock-hotels.ts");



let HotelProvider = class HotelProvider {
    constructor() {
        this.hotels = [];
    ...
    findByName(searchKey) {
        ...
        return Promise.resolve(this.hotels.filter((property) => (property.title + ' ' + property.address + ' ' + property.city + ' ' + property.description).toUpperCase().indexOf(key) > -1));
    }
    getFavorites() {
...
HotelProvider.ctorParameters = () => [];
HotelProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], HotelProvider);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _translate_translate_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./translate/translate.service */ "./src/app/providers/translate/translate.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TranslateProvider", function() { return _translate_translate_service__WEBPACK_IMPORTED_MODULE_0__["TranslateProvider"]; });

/* harmony import */ var _hotel_hotel_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hotel/hotel.service */ "./src/app/providers/hotel/hotel.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HotelProvider", function() { return _hotel_hotel_service__WEBPACK_IMPORTED_MODULE_1__["HotelProvider"]; });

/* harmony import */ var _weather_weather_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weather/weather.service */ "./src/app/providers/weather/weather.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "WeatherService", function() { return _weather_weather_service__WEBPACK_IMPORTED_MODULE_2__["WeatherService"]; });

/* harmony import */ var _cars_cars_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./cars/cars.service */ "./src/app/providers/cars/cars.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "CarsService", function() { return _cars_cars_service__WEBPACK_IMPORTED_MODULE_3__["CarsService"]; });

/* harmony import */ var _activities_activities_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./activities/activities.service */ "./src/app/providers/activities/activities.service.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ActivitiesService", function() { return _activities_activities_service__WEBPACK_IMPORTED_MODULE_4__["ActivitiesService"]; });
...
TranslateProvider = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
], TranslateProvider);
...
module.exports = __webpack_require__(/*! C:\Users\david\Desktop\Coding\IngSoftwareESPOL\HotelSalinas2020\App\hotel_salinas_app_migration\src\main.ts */"./src/main.ts");
