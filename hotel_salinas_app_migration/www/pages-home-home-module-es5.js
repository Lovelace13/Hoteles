  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-home-home-module"], {
    ...
    function srcAppPagesHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        }]), _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateModule"].forChild(), _agm_core__WEBPACK_IMPORTED_MODULE_7__["AgmCoreModule"].forRoot({
    ...
    function srcAppPagesHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var HomePage = /*#__PURE__*/function () {
        function HomePage(navCtrl, menuCtrl, loadingCtrl, translate, hotels) {
          ...
          this.childs = 0;
          this.agmStyles = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].agmStyles; // search conditions
        ...
        _createClass(HomePage, [{
          ...
          value: function initializeItems() {
            this.items = ['La Belle Place - Rio de Janeiro', 'Marshall Hotel - Marshall Islands', 'Maksoud Plaza - São Paulo', 'Hotel Copacabana - Rio de Janeiro', 'Pousada Marés do amanhã - Maragogi'];
          }
        }, {
          key: "itemSelected",
          ...
          key: "childrenArr",
          value: function childrenArr(chil) {
            var child = Number(chil);
            this.childs = Array(child).fill(0).map(function (v, i) {
              return i;
            });
          }
        }, {
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 2:
                      ...
                      loader.onWillDismiss().then(function () {
                        _this.navCtrl.navigateForward('hotel-list');
                      });
