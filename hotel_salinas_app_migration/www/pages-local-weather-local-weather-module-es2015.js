...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LocalWeatherPageModule", function() { return LocalWeatherPageModule; });
...
/* harmony import */ var _local_weather_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./local-weather.page */ "./src/app/pages/local-weather/local-weather.page.ts");
...
let LocalWeatherPageModule = class LocalWeatherPageModule {
};
LocalWeatherPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LocalWeatherPage", function() { return LocalWeatherPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let LocalWeatherPage = class LocalWeatherPage {
    constructor(navCtrl, translate, weatherService, storage) {
    ...
    getWeather(location) {
        ...
        this.weatherService.getWeather(this.location.state, this.location.city).subscribe((weather) => {
            this.weather = weather;
        });
    }
};
LocalWeatherPage.ctorParameters = () => [
...
LocalWeatherPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-local-weather',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./local-weather.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/local-weather/local-weather.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./local-weather.page.scss */ "./src/app/pages/local-weather/local-weather.page.scss")).default]
    })
], LocalWeatherPage);
...
//# sourceMappingURL=pages-local-weather-local-weather-module-es2015.js.map